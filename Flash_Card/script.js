// 1. Initial Mock Dataset Array
const flashcardsData = [
    {
        question: "What is the primary difference between var, let, and const?",
        answer: "var is function-scoped and hoisted. let and const are block-scoped. const prevents variable reassignment."
    },
    {
        question: "What is a closure in JavaScript?",
        answer: "A closure is a function that remembers and has access to its outer lexical scope even after the outer function finishes executing."
    },
    {
        question: "What does DOM stand for in web development?",
        answer: "DOM stands for Document Object Model. It acts as an API architecture wrapper to let scripts dynamically target and alter webpage tags."
    }
];
...
// 3. Grab Mandatory Document Elements
...
// 4. Core Render Function to Synchronize UI with State
function updateUI() {
